  ...
  useEffect(() => {
    if (biz && !initialized) {
      setForm({
        ...
        banner_title: (biz as any).banner_title || '',
        banner_description: (biz as any).banner_description || '',
        banner_link: (biz as any).banner_link || '',
        banner_active: (biz as any).banner_active || false,
